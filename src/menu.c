...
void Menu_Load(MenuPage page)
{
	...
	menu.dad = Char_Dad_New(FIXED_DEC(62,1), FIXED_DEC(60,1));
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "VS CHARA", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 24, FontAlign_Center);
					case 14:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "", {"MEGALO STRIKE BACK", NULL, NULL}}
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "MEGALO STRIKE BACK"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "CREATORS CHARA MOD", false},
                                {StageId_Clwn_2, "     HEXAR", false}, 
				{StageId_Clwn_2, "  Rishimazza", false},
                                {StageId_Clwn_2, "   EGGPLANT", false},
                                {StageId_Clwn_2, "    FIRE MF", false},
				{StageId_Clwn_2, "   PSXFUNKIN", false},
				{StageId_Clwn_2, "   CUCKY DEV", false},
				{StageId_Clwn_2, "   CHARA PSX", false},
				{StageId_Clwn_2, "    VICTOR", false},
